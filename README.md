...
и ручное создание и удаление лидов через второй бот.
...
в боте ввода. Кнопка удаления удаляет лид из CRM после подтверждения и
помечает обе карточки удалёнными. До выбора источника доступна отмена.
